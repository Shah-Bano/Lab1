...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // without this my text would not come up, so i saw online, cant find the referece, but checking if the element exists before and then adding the texts worked
    if (homeWelcome) {
...
document.addEventListener('DOMContentLoaded', function () {
    // Initiallizing the create mediaitem function, it includes the title as a heading, the description as the p tag and images
    function createMediaItem(title, description, imageUrl) {
        ...
        // Over here im creating the elemetns, to ensure the right html tags are used for each
        ...
        //i used the url, which is going to be used as taking the path of the images from my files, speicifcally the styles
    ...
    // Im injecting the content for my first two interests using the element id from the html file
    var mediaContainer = document.getElementById('media-container');

    //The data is inserted in order of declared parameters
    mediaContainer.appendChild(createMediaItem('Emergency Intercom - Podcast', 'A hilarious podcast about YouTubers Enya, Drew, and their camera man, Kai.', './styles/interest1PODCAST.jpg'));
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initiallizing the function, it includes the parameters later used for injecting text
    function createServiceItem(title, description, imageUrl, resumeLink) {
        ...
        // I put my resume in a google drive and used create element a to put in my link for it to be funcrional
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Image element for adding images.  I used a more straight forward and eaasy to read way for this function. (dont have time to replace all lol)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // try to insert it within the list, so i chose createelement to select all of them
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Supposed to help in adding text withint the elemetn
...
function submitForm() {
    ...
    //Assing each item with a variable, and select it using the getelement by id methos
    ...
    // This will redirect user tothe home page after 3 seconds
    setTimeout(function () {
